                ...
                <div class="row">
                    <?php if($url == 'index.php'){ ?>
                        <div class="col-md-6">
                            ...
                            <h3 class="inverse">We have all the best and trending Nollywood movies. Signup below to get all experience</h3> <a href="payment.php" class="btn btn-primary" role="button" smooth>Signup Now</a> </div>
